...
# ============= ADD GAUSSIAN NOISE ==============
add_noise_to_csv('data/train_state.csv', 'data/train_state.csv', noise_std=0.5, fraction=0.4, skip_columns=None)
add_noise_to_csv('data/train_ratethrust.csv', 'data/train_ratethrust.csv', noise_std=0.1, fraction=0.1, skip_columns=None)

# ============= RANDOM DROPOUTS ==============
random_dropout('data/train_state.csv', 'data/train_state.csv', dropout_fraction=0.3, skip_columns=None)
